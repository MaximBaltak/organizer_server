    ...
    async deleteTask(req, res) {
        ...
        if (!taskId) {
            try {
                ...
                console.log(e)
                return res.status(401).json({message: 'there is no task with such userId',userId:req.query})
            }
        } else {
            try {
                ...
                console.log(e)
                return res.status(402).json({message: 'there is no task with such userId or taskId'})
            }
        }
